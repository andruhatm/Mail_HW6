...
public class Nomenclature extends TableImpl<NomenclatureRecord> {
    ...
    /**
     * The column <code>public.Nomenclature.nomenclature_id</code>.
     */
    public final TableField<NomenclatureRecord, Integer> NOMENCLATURE_ID = createField(DSL.name("nomenclature_id"), SQLDataType.INTEGER.nullable(false), this, "");

    /**
     * The column <code>public.Nomenclature.name</code>.
     */
    public final TableField<NomenclatureRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(55).nullable(false), this, "");

    /**
     * The column <code>public.Nomenclature.serial_number</code>.
     */
    public final TableField<NomenclatureRecord, String> SERIAL_NUMBER = createField(DSL.name("serial_number"), SQLDataType.VARCHAR(255).nullable(false), this, "");
