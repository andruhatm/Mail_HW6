...
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, db.tables.pojos.FlywaySchemaHistory, Integer> {
    ...
    @Override
    public Integer getId(db.tables.pojos.FlywaySchemaHistory object) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledRank(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfVersion(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfType(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfScript(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfChecksum(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledBy(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledOn(Timestamp lowerInclusive, Timestamp upperInclusive) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfExecutionTime(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<db.tables.pojos.FlywaySchemaHistory> fetchRangeOfSuccess(Boolean lowerInclusive, Boolean upperInclusive) {
